...
pair< ll, ll > DFS(ll u)
{
    ...
    for(ll i = 0; i < graph[u].size(); i++)
    {
        ...
        {
            temp = DFS(graph[u][i]);
            if(temp.ff + cost[u][i]>aa.ff)
            {
                aa.ss = aa.ff;
                aa.ff = temp.ff + cost[u][i];
            }
            else if(temp.ff + cost[u][i]>aa.ss)
            {
                aa.ss = temp.ff + cost[u][i];
            }
        }
    }
    ar[u] = aa;
